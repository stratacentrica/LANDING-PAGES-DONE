    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute top-8 left-1/2 transform -translate-x-1/2 z-30">
        <div className="w-20 h-20 bg-black/30 backdrop-blur-3xl rounded-2xl border border-white/5 flex items-center justify-center shadow-2xl">
          <div className="text-xs text-white/25 text-center">LOGO HERE</div>
        </div>
      </div>
        ...
        <Card className="bg-black/15 backdrop-blur-3xl border border-white/2 shadow-2xl rounded-3xl overflow-hidden">
          ...
          <CardContent className="p-8 relative z-10">
            <div className="text-center mb-8">
              ...
              <p className="text-purple-100/40 text-lg">APEX clearance only</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-white/50 text-sm font-medium">Name</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-white/50 text-sm font-medium">Email</Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <Label htmlFor="optional" className="text-white/30 text-sm font-medium">Anything else? (Optional)</Label>
                <Textarea
                  id="optional"
                  name="optional"
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full h-14 bg-gradient-to-r from-black/40 to-purple-900/40 hover:from-black/50 hover:to-purple-800/50 text-white font-semibold shadow-xl transition-all duration-300 rounded-xl backdrop-blur-sm border border-purple-400/10"
              >
...
export default CleanWaitingList5;